...
var S3Provider = class extends BaseStorageProvider {
  ...
  async getUploadUrl(fileInfo) {
    ...
    const uploadUrl = await s3RequestPresigner.getSignedUrl(this.s3Client, command, {
      expiresIn: 3600
    });
    return {
      uploadUrl,
...
var FilesystemProvider = class extends BaseStorageProvider {
  ...
  async completeUpload(fileInfo) {
    try {
      const filePath = path__namespace.join(this.config.uploadDir, fileInfo.fileKey);
  ...
  async deleteFile(fileKey) {
    try {
      const filePath = path__namespace.join(this.config.uploadDir, fileKey);
  ...
  async listFiles(prefix) {
    try {
      const directory = prefix ? path__namespace.join(this.config.uploadDir, prefix) : this.config.uploadDir;
  ...
  generateUploadToken(fileKey) {
    return crypto__namespace.createHash("sha256").update(`${fileKey}-${Date.now()}`).digest("hex");
  }
};
...
function useUploader(options) {
  ...
  const getFileUrl = React.useCallback(async (fileKey) => {
    if (!uploaderRef.current) {
      throw new Error("Uploader not initialized");
    }
    return uploaderRef.current.getFileUrl(fileKey);
  }, []);
  const deleteFile = React.useCallback(async (fileKey) => {
    if (!uploaderRef.current) {
      throw new Error("Uploader not initialized");
    }
...
function UploadDialog({
  ...
  if (!isOpen)
    return null;
  return /* @__PURE__ */ React__default.default.createElement("div", { style: styles.overlay, className: "upload-it-dialog-overlay" }, /* @__PURE__ */ React__default.default.createElement("div", { style: styles.dialog, className: "upload-it-dialog" }, /* @__PURE__ */ React__default.default.createElement("div", { style: styles.header, className: "upload-it-dialog-header" }, /* @__PURE__ */ React__default.default.createElement("h3", { style: styles.title, className: "upload-it-dialog-title" }, title), /* @__PURE__ */ React__default.default.createElement(
    "button",
    {
      type: "button",
    ...
    "\xD7"
  )), /* @__PURE__ */ React__default.default.createElement("div", { style: styles.content, className: "upload-it-dialog-content" }, /* @__PURE__ */ React__default.default.createElement("div", { style: styles.icon, className: "upload-it-dialog-icon" }, isComplete ? hasErrors ? /* @__PURE__ */ React__default.default.createElement(
    "svg",
    {
    ...
    /* @__PURE__ */ React__default.default.createElement("circle", { cx: "12", cy: "12", r: "10" }),
    /* @__PURE__ */ React__default.default.createElement("line", { x1: "15", y1: "9", x2: "9", y2: "15" }),
    /* @__PURE__ */ React__default.default.createElement("line", { x1: "9", y1: "9", x2: "15", y2: "15" })
    ...
    /* @__PURE__ */ React__default.default.createElement("path", { d: "M22 11.08V12a10 10 0 1 1-5.93-9.14" }),
    /* @__PURE__ */ React__default.default.createElement("polyline", { points: "22 4 12 14.01 9 11.01" })
  ) : /* @__PURE__ */ React__default.default.createElement(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
    ...
    /* @__PURE__ */ React__default.default.createElement("path", { d: "M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" })
  )), !isComplete ? /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(
    "div",
    {
  ...
  )) : /* @__PURE__ */ React__default.default.createElement("div", { style: styles.status, className: "upload-it-status" }, hasErrors ? "Upload completed with errors" : "Upload complete!"))));
}
...
function UploadButton({
  ...
  const defaultButton = /* @__PURE__ */ React__default.default.createElement(
    "button",
    {
      type: "button",
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, renderButton ? renderButton({
    onClick: handleFileUpload,
